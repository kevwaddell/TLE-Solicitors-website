...
<section id="claim-types-section" class="wide-panel hidden-xs">

	<span class="icon <?php echo $post->post_name; ?>-icon-sml"></span>
	
	<h2>Claim Types</h2>

	<!-- Container start -->
	
		<div id="claim-types-slider" class="carousel slide" data-pause="true" data-wrap="false">
