...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="resetpasswordform" id="resetpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass' ); ?>" method="post">
		<p>
			...
			<input autocomplete="off" name="pass1" id="pass1<?php $template->the_instance(); ?>" class="input form-control" size="20" value="" type="password" autocomplete="off" />
		</p>

		<p>
			<label for="pass2<?php $template->the_instance(); ?>"><?php _e( 'Confirm new password' ); ?></label>
			<input autocomplete="off" name="pass2" id="pass2<?php $template->the_instance(); ?>" class="input form-control" size="20" value="" type="password" autocomplete="off" />
		</p>
		...
		<p class="submit">
			<input type="submit" name="wp-submit" class="btn btn-default btn-lg btn-block" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Reset Password' ); ?>" />
